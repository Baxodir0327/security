package com.example.security.objectmapper;

import com.example.security.Post;
...
public class ObjectMapperTest {
    ...
    void JsonFromObject() throws IOException {
        ...
        OutputStream os = new FileOutputStream("src/test/java/com/example/security/file/data2.txt");
        objectMapper.writeValue(os,post);
    }
    @Test
    void dateformat() throws IOException {
        Post post = new Post();
        post.setId(1);
        post.setBody("bodiku");
        post.setTitle("hsqac");
    ...
    @Test
    void postJson() throws JsonProcessingException {
        String json = """
                {
                  "userId": 1,
                  "id": 1,
    ...
    @Test
    void ObjectFromStringArray() throws JsonProcessingException {


        ObjectMapper objectMapper = new ObjectMapper();
        Post[] posts = objectMapper.readValue(JSONS, Post[].class);

        Arrays.stream(posts).forEach(System.out::println);
    }

    @Test
    void ListFromStringJson() throws JsonProcessingException {


        ObjectMapper objectMapper = new ObjectMapper();
        TypeReference<List<Post>> typeReference = new TypeReference<>() {};
        List<Post> posts = objectMapper.readValue(JSONS, typeReference);
        posts.forEach(System.out::println);
    }

    @Test
    void MapFromStringJson() throws JsonProcessingException {
    ...
    void objectFromFile() throws IOException {
        File file = new File("src/test/java/com/example/security/file/data.txt");
    ...
    void objectFromURL() throws IOException {
        URL url = new URL("https://jsonplaceholder.typicode.com/posts/" + new Random().nextInt(2, 15));
        ObjectMapper objectMapper = new ObjectMapper();
    ...
    void objectFromInputStream() throws IOException {
        InputStream is = new FileInputStream("src/test/java/com/example/security/file/data.txt");
        ObjectMapper objectMapper = new ObjectMapper();
